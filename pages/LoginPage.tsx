  ...
  return (
    ...
    <div className="bg-[#FFF9F5] flex-grow flex items-center justify-center py-12">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center max-w-md">
            <h1 className="text-4xl font-bold tracking-tight text-[#2C3E50]">{t('LoginPage_Title')}</h1>
            ...
            <div className="mt-8 bg-white p-8 rounded-2xl border border-gray-200/80 text-left shadow-lg">
                <form onSubmit={handleLogin} className="space-y-6">
                    <div>
                        <label htmlFor="email" className="block text-sm font-medium text-[#2C3E50]">{t('LoginPage_EmailLabel')}</label>
                        <input 
                          type="email" 
                          id="email"
                          value={email}
                     ...
                     <div>
                        <label htmlFor="password-login" className="block text-sm font-medium text-[#2C3E50]">{t('LoginPage_PasswordLabel')}</label>
                        <input 
                            type="password" 
                            id="password-login" 
                            value={password}
