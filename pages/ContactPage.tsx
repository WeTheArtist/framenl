  ...
  return (
    <div className="bg-[#FFF9F5] flex-grow flex items-center justify-center">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center max-w-2xl">
            <h1 className="text-4xl font-bold tracking-tight text-[#2C3E50]">{t('Contact_Title')}</h1>
            ...
            <div className="mt-8 bg-white p-8 rounded-2xl border border-gray-200/80 text-left shadow-lg">
                <form className="space-y-6">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div>
                            <label htmlFor="name-contact" className="block text-sm font-medium text-[#2C3E50]">{t('Contact_Name')}</label>
                         ...
                         <div>
                            <label htmlFor="email-contact" className="block text-sm font-medium text-[#2C3E50]">{t('Contact_Email')}</label>
                     ...
                     <div>
                        <label htmlFor="subject-contact" className="block text-sm font-medium text-[#2C3E50]">{t('Contact_Subject')}</label>
                     ...
                     <div>
                        <label htmlFor="message-contact" className="block text-sm font-medium text-[#2C3E50]">{t('Contact_Message')}</label>
