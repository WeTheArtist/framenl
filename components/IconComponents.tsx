...
export const StarIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className={className}>
    <path fillRule="evenodd" d="M10.868 2.884c.321-.662 1.215-.662 1.536 0l1.861 3.841 4.232.616c.732.107 1.022.992.494 1.503l-3.06 2.983.722 4.215c.125.728-.638 1.283-1.296.952L10 17.555l-3.775 1.985c-.658.331-1.421-.224-1.296-.952l.722-4.215-3.06-2.983c-.528-.511-.238-1.396.494-1.503l4.232-.616 1.861-3.841z" clipRule="evenodd" />
  </svg>
);
